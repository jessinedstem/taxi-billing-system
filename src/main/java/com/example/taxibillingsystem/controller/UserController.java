...
public class UserController {
    ...
    @PutMapping("/account-balance/{userId}")
    public ResponseEntity<UserResponse> accountBalanceDetails(@Valid @RequestBody AccountBalanceRequest accountBalanceRequest,
