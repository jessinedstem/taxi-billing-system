...
public class TaxiControllerTest {
        ...
        when(taxiService.getBookingDetails(any(Long.class)))
                .thenReturn(
                        BookingResponse.builder()
                                ...
                                .build());
        mockMvc.perform(
                        get("/taxi/booking-details/{bookingId}", 1L)
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testCancelABooking() throws Exception {
        ...
        mockMvc.perform(
                        delete("/taxi/cancel/{bookingId}", 1L)
                                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void testCalculateFare() throws Exception {
        ...
        FareCalculationResponse mockCalculationResponse =
        ...
        mockMvc.perform(
                        post("/taxi/calculate-fare/" + bookingId)
                                .contentType(MediaType.APPLICATION_JSON)
